        ...
        return (
          <>
            <div className="flex items-center justify-between">
                ...
                onChange={(e) => setParams({ ...binomialParams, n: parseInt(e.target.value, 10) || 1 })}
         ...
         return (
          <>
            <div className="flex items-center justify-between">
                ...
                onChange={(e) => setParams({ ...poissonParams, lambda: parseFloat(e.target.value) || 0.1 })}
                className="w-20 text-center text-sm font-semibold text-primary-600 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500"
                />
            </div>
            <input
        ...
        <div className="grid grid-cols-3 gap-2">
          {Object.values(DiscreteDistribution).map((dist) => (
            <button
              ...
              className={`py-2 px-2 text-xs md:text-sm font-semibold rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 ${
                distribution === dist
